...
def test_reconstructs_epochs_and_preserves_line_changes():
    records = [
        ...
        obs("c", "2026-09-14T12:00:00+00:00", market_family="total", line=8.5, selection="over"),
    ]
...
def test_opening_and_closing_are_observed_only():
    ...
    assert select_observed_price(epoch, "home", "2026-09-14T10:30:00+00:00").observation_id == "a"
