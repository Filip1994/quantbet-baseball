...
def test_registered_pick_can_override_paper_stake_but_not_currency() -> None:
    preliminary_home = _observation(
        observation_id="00000000-0000-0000-0000-000000000105",
        selection="home",
        odds=2.10,
        observed_at="2026-09-20T17:00:00+00:00",
    )
    preliminary_away = _observation(
        observation_id="00000000-0000-0000-0000-000000000106",
        selection="away",
        odds=1.80,
        observed_at="2026-09-20T17:00:00+00:00",
    )
    ...
    final_home = _observation(
        observation_id="00000000-0000-0000-0000-000000000107",
        selection="home",
        odds=2.00,
        observed_at="2026-09-20T17:02:00+00:00",
    )
    ...
    pick = build_registered_pick(
        ...
        entry_observation=final_home,
        registered_at="2026-09-20T17:02:12+00:00",
        paper_stake_minor=50_000,
    )
    assert pick.paper_stake_minor == 50_000
    assert pick.currency == "RSD"
